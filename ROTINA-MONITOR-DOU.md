# Rotina de Monitoramento Diário do DOU — Advocacia Previdenciária

**Escritório:** Paulo Roberto Tercini Filho  
**Versão:** 2.0 (revisada em 2026-06-04)
...
### Estrutura do relatório da tarefa
...
|--------|------|----------|
| 2.0 | 2026-06-04 | Plugin alvo identificado por nome com fallback; lista de termos ampliada (EC 103, leis, temas STF, PMF); bloco PAGINAÇÃO com `&start=N`; FALLBACK DE SELETOR para mudanças de markup; lista de exclusão de atos administrativos; configuração condicional de dueDateTime/reminderDateTime; tratamento de falha do Graph (refresh + retry + fallback manual); instrução de inserção do CHANGELOG após o `---` do cabeçalho; caminhos relativos ao repositório no relatório |
| 1.0 | 2026-05-01 | Versão inicial |
