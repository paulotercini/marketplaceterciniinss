...
-- Quando o benefício cai na conta, pelo último algarismo do NB ANTES do
-- traço (o dígito depois do hífen é verificador e não conta): 0104-7 é
-- final 4.
--
-- São duas tabelas, e a diferença importa: quem recebe até um salário mínimo
-- é pago ainda dentro do mês de competência; quem recebe acima recebe nos
-- primeiros dias do mês seguinte.
--
-- ⚠ ESTA TABELA É DE 2026, e vai até a competência dez/26 (paga em jan/27).
-- Fora desse intervalo o sistema NÃO adivinha: ele avisa que a tabela do ano
-- novo precisa ser cadastrada. Chutar data de pagamento para cliente é pior
-- que não informar nada.
--
-- Para atualizar em 2027: pegue a tabela nova no site do INSS e substitua o
-- bloco de INSERT abaixo. Nada mais no sistema precisa mudar.
create table if not exists inss_calendario (
  competencia date     not null,          -- 1º dia do mês de referência
  faixa       text     not null check (faixa in ('ate','acima')),
  final       smallint not null check (final between 0 and 9),
  pagamento   date     not null,
  primary key (competencia, faixa, final)
);
insert into inss_calendario (competencia, faixa, final, pagamento) values
  ('2025-12-01','ate',1,'2025-12-22'),
  ('2025-12-01','acima',1,'2026-01-02'),
  ('2025-12-01','ate',2,'2025-12-23'),
  ('2025-12-01','acima',2,'2026-01-05'),
  ('2025-12-01','ate',3,'2025-12-26'),
  ('2025-12-01','acima',3,'2026-01-06'),
  ('2025-12-01','ate',4,'2025-12-29'),
  ('2025-12-01','acima',4,'2026-01-07'),
  ('2025-12-01','ate',5,'2025-12-30'),
  ('2025-12-01','acima',5,'2026-01-08'),
  ('2025-12-01','ate',6,'2026-01-02'),
  ('2025-12-01','acima',6,'2026-01-02'),
  ('2025-12-01','ate',7,'2026-01-05'),
  ('2025-12-01','acima',7,'2026-01-05'),
  ('2025-12-01','ate',8,'2026-01-06'),
  ('2025-12-01','acima',8,'2026-01-06'),
  ('2025-12-01','ate',9,'2026-01-07'),
  ('2025-12-01','acima',9,'2026-01-07'),
  ('2025-12-01','ate',0,'2026-01-08'),
  ('2025-12-01','acima',0,'2026-01-08'),
  ('2026-01-01','ate',1,'2026-01-26'),
  ('2026-01-01','acima',1,'2026-02-02'),
  ('2026-01-01','ate',2,'2026-01-27'),
  ('2026-01-01','acima',2,'2026-02-03'),
  ('2026-01-01','ate',3,'2026-01-28'),
  ('2026-01-01','acima',3,'2026-02-04'),
  ('2026-01-01','ate',4,'2026-01-29'),
  ('2026-01-01','acima',4,'2026-02-05'),
  ('2026-01-01','ate',5,'2026-01-30'),
  ('2026-01-01','acima',5,'2026-02-06'),
  ('2026-01-01','ate',6,'2026-02-02'),
  ('2026-01-01','acima',6,'2026-02-02'),
  ('2026-01-01','ate',7,'2026-02-03'),
  ('2026-01-01','acima',7,'2026-02-03'),
  ('2026-01-01','ate',8,'2026-02-04'),
  ('2026-01-01','acima',8,'2026-02-04'),
  ('2026-01-01','ate',9,'2026-02-05'),
  ('2026-01-01','acima',9,'2026-02-05'),
  ('2026-01-01','ate',0,'2026-02-06'),
  ('2026-01-01','acima',0,'2026-02-06'),
  ('2026-02-01','ate',1,'2026-02-23'),
  ('2026-02-01','acima',1,'2026-03-02'),
  ('2026-02-01','ate',2,'2026-02-24'),
  ('2026-02-01','acima',2,'2026-03-03'),
  ('2026-02-01','ate',3,'2026-02-25'),
  ('2026-02-01','acima',3,'2026-03-04'),
  ('2026-02-01','ate',4,'2026-02-26'),
  ('2026-02-01','acima',4,'2026-03-05'),
  ('2026-02-01','ate',5,'2026-02-27'),
  ('2026-02-01','acima',5,'2026-03-06'),
  ('2026-02-01','ate',6,'2026-03-02'),
  ('2026-02-01','acima',6,'2026-03-02'),
  ('2026-02-01','ate',7,'2026-03-03'),
  ('2026-02-01','acima',7,'2026-03-03'),
  ('2026-02-01','ate',8,'2026-03-04'),
  ('2026-02-01','acima',8,'2026-03-04'),
  ('2026-02-01','ate',9,'2026-03-05'),
  ('2026-02-01','acima',9,'2026-03-05'),
  ('2026-02-01','ate',0,'2026-03-06'),
  ('2026-02-01','acima',0,'2026-03-06'),
  ('2026-03-01','ate',1,'2026-03-25'),
  ('2026-03-01','acima',1,'2026-04-01'),
  ('2026-03-01','ate',2,'2026-03-26'),
  ('2026-03-01','acima',2,'2026-04-02'),
  ('2026-03-01','ate',3,'2026-03-27'),
  ('2026-03-01','acima',3,'2026-04-06'),
  ('2026-03-01','ate',4,'2026-03-30'),
  ('2026-03-01','acima',4,'2026-04-07'),
  ('2026-03-01','ate',5,'2026-03-31'),
  ('2026-03-01','acima',5,'2026-04-08'),
  ('2026-03-01','ate',6,'2026-04-01'),
  ('2026-03-01','acima',6,'2026-04-01'),
  ('2026-03-01','ate',7,'2026-04-02'),
  ('2026-03-01','acima',7,'2026-04-02'),
  ('2026-03-01','ate',8,'2026-04-06'),
  ('2026-03-01','acima',8,'2026-04-06'),
  ('2026-03-01','ate',9,'2026-04-07'),
  ('2026-03-01','acima',9,'2026-04-07'),
  ('2026-03-01','ate',0,'2026-04-08'),
  ('2026-03-01','acima',0,'2026-04-08'),
  ('2026-04-01','ate',1,'2026-04-24'),
  ('2026-04-01','acima',1,'2026-05-04'),
  ('2026-04-01','ate',2,'2026-04-27'),
  ('2026-04-01','acima',2,'2026-05-05'),
  ('2026-04-01','ate',3,'2026-04-28'),
  ('2026-04-01','acima',3,'2026-05-06'),
  ('2026-04-01','ate',4,'2026-04-29'),
  ('2026-04-01','acima',4,'2026-05-07'),
  ('2026-04-01','ate',5,'2026-04-30'),
  ('2026-04-01','acima',5,'2026-05-08'),
  ('2026-04-01','ate',6,'2026-05-04'),
  ('2026-04-01','acima',6,'2026-05-04'),
  ('2026-04-01','ate',7,'2026-05-05'),
  ('2026-04-01','acima',7,'2026-05-05'),
  ('2026-04-01','ate',8,'2026-05-06'),
  ('2026-04-01','acima',8,'2026-05-06'),
  ('2026-04-01','ate',9,'2026-05-07'),
  ('2026-04-01','acima',9,'2026-05-07'),
  ('2026-04-01','ate',0,'2026-05-08'),
  ('2026-04-01','acima',0,'2026-05-08'),
  ('2026-05-01','ate',1,'2026-05-25'),
  ('2026-05-01','acima',1,'2026-06-01'),
  ('2026-05-01','ate',2,'2026-05-26'),
  ('2026-05-01','acima',2,'2026-06-02'),
  ('2026-05-01','ate',3,'2026-05-27'),
  ('2026-05-01','acima',3,'2026-06-03'),
  ('2026-05-01','ate',4,'2026-05-28'),
  ('2026-05-01','acima',4,'2026-06-05'),
  ('2026-05-01','ate',5,'2026-05-29'),
  ('2026-05-01','acima',5,'2026-06-08'),
  ('2026-05-01','ate',6,'2026-06-01'),
  ('2026-05-01','acima',6,'2026-06-01'),
  ('2026-05-01','ate',7,'2026-06-02'),
  ('2026-05-01','acima',7,'2026-06-02'),
  ('2026-05-01','ate',8,'2026-06-03'),
  ('2026-05-01','acima',8,'2026-06-03'),
  ('2026-05-01','ate',9,'2026-06-05'),
  ('2026-05-01','acima',9,'2026-06-05'),
  ('2026-05-01','ate',0,'2026-06-08'),
  ('2026-05-01','acima',0,'2026-06-08'),
  ('2026-06-01','ate',1,'2026-06-24'),
  ('2026-06-01','acima',1,'2026-07-01'),
  ('2026-06-01','ate',2,'2026-06-25'),
  ('2026-06-01','acima',2,'2026-07-02'),
  ('2026-06-01','ate',3,'2026-06-26'),
  ('2026-06-01','acima',3,'2026-07-03'),
  ('2026-06-01','ate',4,'2026-06-29'),
  ('2026-06-01','acima',4,'2026-07-06'),
  ('2026-06-01','ate',5,'2026-06-30'),
  ('2026-06-01','acima',5,'2026-07-07'),
  ('2026-06-01','ate',6,'2026-07-01'),
  ('2026-06-01','acima',6,'2026-07-01'),
  ('2026-06-01','ate',7,'2026-07-02'),
  ('2026-06-01','acima',7,'2026-07-02'),
  ('2026-06-01','ate',8,'2026-07-03'),
  ('2026-06-01','acima',8,'2026-07-03'),
  ('2026-06-01','ate',9,'2026-07-06'),
  ('2026-06-01','acima',9,'2026-07-06'),
  ('2026-06-01','ate',0,'2026-07-07'),
  ('2026-06-01','acima',0,'2026-07-07'),
  ('2026-07-01','ate',1,'2026-07-27'),
  ('2026-07-01','acima',1,'2026-08-03'),
  ('2026-07-01','ate',2,'2026-07-28'),
  ('2026-07-01','acima',2,'2026-08-04'),
  ('2026-07-01','ate',3,'2026-07-29'),
  ('2026-07-01','acima',3,'2026-08-05'),
  ('2026-07-01','ate',4,'2026-07-30'),
  ('2026-07-01','acima',4,'2026-08-06'),
  ('2026-07-01','ate',5,'2026-07-31'),
  ('2026-07-01','acima',5,'2026-08-07'),
  ('2026-07-01','ate',6,'2026-08-03'),
  ('2026-07-01','acima',6,'2026-08-03'),
  ('2026-07-01','ate',7,'2026-08-04'),
  ('2026-07-01','acima',7,'2026-08-04'),
  ('2026-07-01','ate',8,'2026-08-05'),
  ('2026-07-01','acima',8,'2026-08-05'),
  ('2026-07-01','ate',9,'2026-08-06'),
  ('2026-07-01','acima',9,'2026-08-06'),
  ('2026-07-01','ate',0,'2026-08-07'),
  ('2026-07-01','acima',0,'2026-08-07'),
  ('2026-08-01','ate',1,'2026-08-25'),
  ('2026-08-01','acima',1,'2026-09-01'),
  ('2026-08-01','ate',2,'2026-08-26'),
  ('2026-08-01','acima',2,'2026-09-02'),
  ('2026-08-01','ate',3,'2026-08-27'),
  ('2026-08-01','acima',3,'2026-09-03'),
  ('2026-08-01','ate',4,'2026-08-28'),
  ('2026-08-01','acima',4,'2026-09-04'),
  ('2026-08-01','ate',5,'2026-08-31'),
  ('2026-08-01','acima',5,'2026-09-08'),
  ('2026-08-01','ate',6,'2026-09-01'),
  ('2026-08-01','acima',6,'2026-09-01'),
  ('2026-08-01','ate',7,'2026-09-02'),
  ('2026-08-01','acima',7,'2026-09-02'),
  ('2026-08-01','ate',8,'2026-09-03'),
  ('2026-08-01','acima',8,'2026-09-03'),
  ('2026-08-01','ate',9,'2026-09-04'),
  ('2026-08-01','acima',9,'2026-09-04'),
  ('2026-08-01','ate',0,'2026-09-08'),
  ('2026-08-01','acima',0,'2026-09-08'),
  ('2026-09-01','ate',1,'2026-09-24'),
  ('2026-09-01','acima',1,'2026-10-01'),
  ('2026-09-01','ate',2,'2026-09-25'),
  ('2026-09-01','acima',2,'2026-10-02'),
  ('2026-09-01','ate',3,'2026-09-28'),
  ('2026-09-01','acima',3,'2026-10-05'),
  ('2026-09-01','ate',4,'2026-09-29'),
  ('2026-09-01','acima',4,'2026-10-06'),
  ('2026-09-01','ate',5,'2026-09-30'),
  ('2026-09-01','acima',5,'2026-10-07'),
  ('2026-09-01','ate',6,'2026-10-01'),
  ('2026-09-01','acima',6,'2026-10-01'),
  ('2026-09-01','ate',7,'2026-10-02'),
  ('2026-09-01','acima',7,'2026-10-02'),
  ('2026-09-01','ate',8,'2026-10-05'),
  ('2026-09-01','acima',8,'2026-10-05'),
  ('2026-09-01','ate',9,'2026-10-06'),
  ('2026-09-01','acima',9,'2026-10-06'),
  ('2026-09-01','ate',0,'2026-10-07'),
  ('2026-09-01','acima',0,'2026-10-07'),
  ('2026-10-01','ate',1,'2026-10-26'),
  ('2026-10-01','acima',1,'2026-11-03'),
  ('2026-10-01','ate',2,'2026-10-27'),
  ('2026-10-01','acima',2,'2026-11-04'),
  ('2026-10-01','ate',3,'2026-10-28'),
  ('2026-10-01','acima',3,'2026-11-05'),
  ('2026-10-01','ate',4,'2026-10-29'),
  ('2026-10-01','acima',4,'2026-11-06'),
  ('2026-10-01','ate',5,'2026-10-30'),
  ('2026-10-01','acima',5,'2026-11-09'),
  ('2026-10-01','ate',6,'2026-11-03'),
  ('2026-10-01','acima',6,'2026-11-03'),
  ('2026-10-01','ate',7,'2026-11-04'),
  ('2026-10-01','acima',7,'2026-11-04'),
  ('2026-10-01','ate',8,'2026-11-05'),
  ('2026-10-01','acima',8,'2026-11-05'),
  ('2026-10-01','ate',9,'2026-11-06'),
  ('2026-10-01','acima',9,'2026-11-06'),
  ('2026-10-01','ate',0,'2026-11-09'),
  ('2026-10-01','acima',0,'2026-11-09'),
  ('2026-11-01','ate',1,'2026-11-24'),
  ('2026-11-01','acima',1,'2026-12-01'),
  ('2026-11-01','ate',2,'2026-11-25'),
  ('2026-11-01','acima',2,'2026-12-02'),
  ('2026-11-01','ate',3,'2026-11-26'),
  ('2026-11-01','acima',3,'2026-12-03'),
  ('2026-11-01','ate',4,'2026-11-27'),
  ('2026-11-01','acima',4,'2026-12-04'),
  ('2026-11-01','ate',5,'2026-11-30'),
  ('2026-11-01','acima',5,'2026-12-07'),
  ('2026-11-01','ate',6,'2026-12-01'),
  ('2026-11-01','acima',6,'2026-12-01'),
  ('2026-11-01','ate',7,'2026-12-02'),
  ('2026-11-01','acima',7,'2026-12-02'),
  ('2026-11-01','ate',8,'2026-12-03'),
  ('2026-11-01','acima',8,'2026-12-03'),
  ('2026-11-01','ate',9,'2026-12-04'),
  ('2026-11-01','acima',9,'2026-12-04'),
  ('2026-11-01','ate',0,'2026-12-07'),
  ('2026-11-01','acima',0,'2026-12-07'),
  ('2026-12-01','ate',1,'2026-12-22'),
  ('2026-12-01','acima',1,'2027-01-04'),
  ('2026-12-01','ate',2,'2026-12-23'),
  ('2026-12-01','acima',2,'2027-01-05'),
  ('2026-12-01','ate',3,'2026-12-28'),
  ('2026-12-01','acima',3,'2027-01-06'),
  ('2026-12-01','ate',4,'2026-12-29'),
  ('2026-12-01','acima',4,'2027-01-07'),
  ('2026-12-01','ate',5,'2026-12-30'),
  ('2026-12-01','acima',5,'2027-01-08'),
  ('2026-12-01','ate',6,'2027-01-04'),
  ('2026-12-01','acima',6,'2027-01-04'),
  ('2026-12-01','ate',7,'2027-01-05'),
  ('2026-12-01','acima',7,'2027-01-05'),
  ('2026-12-01','ate',8,'2027-01-06'),
  ('2026-12-01','acima',8,'2027-01-06'),
  ('2026-12-01','ate',9,'2027-01-07'),
  ('2026-12-01','acima',9,'2027-01-07'),
  ('2026-12-01','ate',0,'2027-01-08'),
  ('2026-12-01','acima',0,'2027-01-08')
on conflict (competencia, faixa, final) do nothing;

-- a maioria dos clientes do escritório recebe um salário mínimo; quem recebe
