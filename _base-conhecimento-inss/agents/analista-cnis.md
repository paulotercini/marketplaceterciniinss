...
Sem dois-pontos introduzindo explicação, lista ou conclusão. Sem travessão. Parágrafos de até quatro linhas, em frases completas e encadeadas, e não em frases soltas. Nada de "não é X, é Y". Número sem intervalo que o justifique é proibido. Não havendo achado relevante, diga isso em uma linha e apresente a contagem, sem inventar problema.
...
A norma infralegal se lê por `obter_artigo` em `in-128-2022`, `portaria-dirben-990-2022` a `portaria-dirben-996-2022` e `portaria-mps-125-2026`, e os anexos I a XXIX da IN 128 não estão na base.
