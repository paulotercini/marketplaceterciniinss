...
description: "Fluxo operacional pró-segurado dos sistemas administrativos do INSS, incluindo Meu INSS, PAT/GERID, HISCRE, INFBEN, DataPrev, Gov.br e protocolo eletrônico de requerimentos. Use SEMPRE que mencionar Meu INSS, MEUINSS, PAT, GERID, HISCRE, INFBEN, DataPrev, Gov.br, protocolo INSS, requerimento eletrônico INSS, exigência eletrônica, INFBEN, OCAB, telegrama INSS, recurso pelo Meu INSS, recurso pelo PAT, agendamento de perícia, agendamento de PRP, atendimento INSS, login Gov.br, certificado digital INSS, gerador de senha INSS, recadastrar Meu INSS, plataforma de procuradores, gestão de procurações INSS, procuração eletrônica INSS, Portaria Conjunta DTI DIRBEN 21/2026, selo prata Gov.br, selo ouro Gov.br, nível conta Gov.br procuração, representante digital INSS, autorização específica serviço Meu INSS, revogação procuração eletrônica, anexar documentos Meu INSS, comunicar autorizado, prova de vida digital, recadastramento biométrico. Cruza com base-cnis-conferencia-divergencias, base-pericia-medica-federal-telepericia, base-canais-falabr-corregedoria-cgu, base-pfe-inss-anpd-dpu-conade, base-aposentadoria-futura-pipeline e base-erro-administrativo-iea-13975."
---
...
Vigência: publicada em edição extra do DOU de 10/06/2026, com efeitos retroativos a 2 de junho de 2026
Resumo da alteração: A portaria altera a Portaria Conjunta DTI/DIRBEN/INSS nº 10, de 4 de novembro de 2025, que disciplina o uso da procuração eletrônica na plataforma Meu INSS. As principais mudanças são quatro. Primeiro, o representante (advogado ou procurador do escritório) pode agora iniciar o pedido de procuração eletrônica a partir de sua própria conta Gov.br, sem depender da iniciativa do cliente. Segundo, a autorização deixa de ser genérica e passa a indicar especificamente quais serviços o representante pode acessar, com validade delimitada no ato do cadastro. Terceiro, tanto o outorgante (cliente) quanto o outorgado (advogado/procurador) precisam ter conta Gov.br com selo prata ou ouro; contas no nível bronze não são aceitas para essa funcionalidade. Quarto, qualquer das partes pode revogar a procuração eletrônica a qualquer momento diretamente pela conta Gov.br, sem necessidade de comparecimento à APS.
Impacto na advocacia: O escritório precisará verificar, a partir de agora, se o cliente possui conta Gov.br com nível prata ou ouro antes de iniciar o fluxo de procuração eletrônica. Clientes com conta bronze precisarão ser orientados a elevar o nível antes do cadastro da procuração. A nova funcionalidade de iniciativa pelo representante facilita o fluxo operacional, pois o escritório pode iniciar o processo sem aguardar ação do cliente. A granularidade de serviços autorizados exige que, em cada nova procuração, os serviços relevantes sejam selecionados explicitamente.
Estratégia: Incluir no checklist de abertura de caso a verificação do nível Gov.br do cliente. Se bronze, orientar upgrade via app Gov.br antes da primeira reunião. Em caso de recusa de acesso pelo sistema por insuficiência de nível de conta, documentar tentativas com print e pleitear prazo adicional.
