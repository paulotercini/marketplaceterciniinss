...
description: "Fluxo operacional pró-segurado dos sistemas administrativos do INSS, incluindo Meu INSS, PAT/GERID, HISCRE, INFBEN, DataPrev, Gov.br e protocolo eletrônico de requerimentos. Use SEMPRE que mencionar Meu INSS, MEUINSS, PAT, GERID, HISCRE, INFBEN, DataPrev, Gov.br, protocolo INSS, requerimento eletrônico INSS, exigência eletrônica, INFBEN, OCAB, telegrama INSS, recurso pelo Meu INSS, recurso pelo PAT, agendamento de perícia, agendamento de PRP, atendimento INSS, login Gov.br, certificado digital INSS, gerador de senha INSS, recadastrar Meu INSS, plataforma de procuradores, gestão de procurações INSS, anexar documentos Meu INSS, comunicar autorizado, prova de vida digital, recadastramento biométrico, Portaria Conjunta DTI/DIRBEN/INSS 21/2026, procuração eletrônica Meu INSS 2026, conta Gov.br prata ouro procuração, nível conta Gov.br procuração INSS, advogado iniciar procuração eletrônica INSS. Cruza com base-cnis-conferencia-divergencias, base-pericia-medica-federal-telepericia, base-canais-falabr-corregedoria-cgu, base-pfe-inss-anpd-dpu-conade, base-aposentadoria-futura-pipeline e base-erro-administrativo-iea-13975."
---
...
Vigência: 2 de junho de 2026 (retroativa), publicada em edição extra do DOU em 10 de junho de 2026
Resumo da alteração: Altera a Portaria Conjunta DTI/DIRBEN/INSS nº 10/2025, que regula o uso da procuração eletrônica na plataforma Meu INSS. Mudanças centrais: o representante (advogado) passa a poder iniciar o pedido de procuração pelo próprio Gov.br, sem que o segurado precise protocolar o pedido primeiro. Após a solicitação pelo representante, o segurado recebe notificação e deve confirmar com assinatura eletrônica vinculada ao Gov.br. Ambas as partes precisam de conta Gov.br com selo prata ou ouro. Ao registrar a procuração, devem ser especificados quais serviços o representante pode acessar. Qualquer das partes pode revogar a procuração a qualquer momento pelo próprio Gov.br, sem comparecimento presencial.
Impacto na advocacia: O escritório precisa verificar o nível da conta Gov.br do cliente antes de tentar cadastrar a procuração eletrônica. Clientes com conta bronze (sem validação biométrica ou documental) não poderão ser procurados eletronicamente até realizarem o upgrade. O novo fluxo permite ao advogado iniciar o cadastramento da procuração, eliminando a necessidade de o cliente acessar o Meu INSS para dar o primeiro passo.
Estratégia: Incluir a verificação do nível Gov.br (prata ou ouro) no checklist de onboarding do cliente. Orientar os clientes a validarem a conta Gov.br por biometria facial ou documento com foto antes da primeira consulta ao escritório. Em caso de recusa do INSS fundamentada exclusivamente no nível insuficiente da conta, verificar a base legal da exigência e, se ela não encontrar suporte expresso na Lei 8.213/91 ou no Decreto 3.048/99, formular impugnação administrativa arguindo excesso regulatório.
Link oficial: https://www.in.gov.br/web/dou (edição extra DOU nº 107-A, 10/06/2026)
