# B92 — Jurisprudência Verificada e Refutação
...
Tese. Constitucionalidade do NTEP (art. 21-A da Lei 8.213/91). Presunção legal de nexo em correspondência CID-CNAE.

Fonte oficial em https://portal.stf.jus.br

Aplicação pró-segurado. Inverte o ônus da prova em favor do segurado.
...
Aplicação pró-segurado. Permite inclusão de verbas salariais no cálculo da RMI.
...
Argumento adversário. Não há NTEP para o caso.

Refutação. Ausência de NTEP não afasta nexo. Cabe comprovação por nexo individual com perícia técnica, laudos de engenharia do trabalho, PGR e LTCAT. NTEP é apenas uma das vias.

### Argumento 4 — Acidente de trajeto não é acidente de trabalho

Argumento adversário. Acidente no percurso residência-trabalho não é equiparado após MP 905.

Refutação. MP 905/2019 foi revogada. Art. 21, IV, d, Lei 8.213/91 em pleno vigor. Acidente de trajeto continua equiparado a acidente de trabalho.

### Argumento 5 — Doença mental não é ocupacional

Argumento adversário. Transtornos mentais não têm nexo com o trabalho.

Refutação. Portaria MTE 1.419/2024 atualizou a NR-1 para incluir riscos psicossociais. CID-11 reconhece burnout como fenômeno ocupacional. OMS, Nota Técnica SIT/MTb e doutrina especializada confirmam nexo em casos concretos.

### Argumento 6 — Segurado concorreu para o acidente
...
Primeiro, levantar CID e CNAE e verificar NTEP.

Segundo, obter CAT ou providenciar emissão por médico, sindicato ou segurado.

Terceiro, coletar PGR, LTCAT, PPP e documentação interna.

Quarto, em casos complexos, perícia de engenharia do trabalho além da médica.
...
Frederico Amado, em Direito Previdenciário, sustenta a interpretação extensiva do art. 21 e a proteção ampla em caso de concausa.

Hugo Goes, em Manual, detalha o NTEP e a inversão do ônus da prova.

Fábio Zambitte Ibrahim, em Curso, defende reconhecimento amplo de doenças ocupacionais, incluindo transtornos mentais.

Wladimir Novaes Martinez analisa a evolução do conceito e defende inclusão dos riscos psicossociais.

Sebastião Geraldo de Oliveira, em Indenizações por Acidente do Trabalho, aprofunda a concausa e a responsabilidade solidária.

O IBDP sustenta institucionalmente a proteção integral e o reconhecimento de doenças ocupacionais emergentes.

## 5. Diligência de atualização

Revalidar Anexo II do Decreto 3.048/99 (listas A, B, C). Verificar evolução da Portaria MTE 1.419/2024 e NR-1. Acompanhar precedentes novos sobre transtornos mentais ocupacionais. Acionar `precedentes-previdenciarios`.
