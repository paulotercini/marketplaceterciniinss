...
A persuasão segue as oito técnicas da seção "Persuasão com base empírica" de `base-protocolo-operacional-escritorio/references/PADRAO-DE-ESCRITA.md` (Onda 157), lidas antes da redação. Na prática, o fato vem com número, data e ID, a narrativa segue a ordem de causa e consequência, o primeiro número lido é o do segurado, o argumento mais forte abre a seção, a defesa previsível do INSS é nomeada e refutada, e o que o INSS já reconheceu serve de premissa. Nenhuma técnica de PNL entra na peça. Em recurso dirigido ao STJ, ao STF ou à TNU, os títulos são nominais, conforme a exceção registrada em `references/MECANICA-DOCX.md`.
