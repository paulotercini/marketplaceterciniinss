...
**A idade do texto é critério.** O corpus foi baixado em 31/05/2026 e a Lei 8.213 já registra alteração de 2026 no cabeçalho do arquivo. Antes de citar dispositivo de norma que muda com frequência, roda-se `verificar_atualizacao`, e havendo divergência de hash a redação se lê na fonte oficial, não no banco.

**Três limitações mudam a conduta e precisam ser ditas na resposta.**

1. **Vigência inferida.** O servidor toma como vigente a última versão não revogada da pilha do texto compilado, o que é inferência de ordem e não leitura de marca. Redação decisiva para a tese se confere na fonte oficial.
2. **Histórico por ANO, e o ano é o da norma alteradora.** O marcador do texto compilado traz o ano do ato que alterou, não o início da vigência, de modo que vacatio legis e conversão de medida provisória não aparecem. A pergunta por data exata não tem resposta segura nesta base.
3. **Os Anexos II, III e IV do Decreto 3.048/99 ficaram de fora,** por serem tabela. Busca por ruído ou por agente químico **NÃO alcança o Decreto 3.048**, e o substituto que está na base é o **Decreto 53.831/1964**, com o Quadro Anexo dos agentes nocivos pré-1995.
...
A forma de pesquisar, com as cinco ferramentas, os casos de exercício e o estado da medição, está em `references/PESQUISA-NO-MCP-NORMAS.md`.
