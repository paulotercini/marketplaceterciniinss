...
Skill temática pró-segurada do acervo do escritório Paulo Roberto Tercini Filho. Orienta a concessão do salário-maternidade em suas várias espécies (parto, adoção, aborto não criminoso, natimorto) e para todas as categorias de seguradas (empregada, CI, facultativa, especial rural, desempregada, MEI, doméstica). Objetivo único é defender a segurada e as famílias.

## Marco normativo central

CF/88, art. 7º, XVIII. Licença-maternidade de 120 dias.

Lei 8.213/91, art. 71. Salário-maternidade à segurada gestante (ou mãe adotiva/guardiã para fins de adoção).
...
Quinta, salário-maternidade ao pai em caso de óbito da mãe (LC 146/2014).
...
## Cenários operacionais pró-segurada
...
Sexto, óbito da mãe no parto. Transferência para o pai (LC 146/2014). 120 dias.

Sétimo, aborto espontâneo ou natimorto. B81. 14 dias a 120 dias conforme marco (jurisprudência).

Oitavo, gravidez de risco com afastamento antes do parto. B80 antecipado a critério médico (até 28 dias antes do parto).

Nono, adoção conjunta. Apenas um dos adotantes recebe o B82. Planejamento familiar relevante.
...
Quinto, em adoção, provar os 10 dias cumpridos de guarda com sentença judicial.

## Integração com outras skills

Ao redigir peça, acione `peticao-previdenciaria`.
Ao verificar qualidade, acione `periodo-graca-qualidade-segurado`.
Em segurada rural, acione `segurado-especial-rural` e `perspectiva-genero-previdenciario`.
Ao reunir documentação, acione `documentos-comprobatorios-in128`.
Ao buscar precedentes, acione `precedentes-previdenciarios`.

## Alertas

Primeiro, DIB é na data do parto (ou 28 dias antes a critério médico). Em adoção, na sentença de guarda ou adoção.
...
Hugo Goes, em Manual, detalha os requisitos e as categorias de seguradas.

Fábio Zambitte Ibrahim, em Curso, defende interpretação pró-segurada no critério de carência e qualidade.

Wladimir Novaes Martinez analisa a evolução do benefício.

Jane Berwanger trata da segurada especial rural.

O IBDP sustenta institucionalmente a proteção integral à maternidade.
...
Norma: Lei nº 15.415, de 25 de maio de 2026 (pub. DOU 26/05/2026)
Órgão: Presidência da República / Congresso Nacional
Vigência: Desde a data de publicação, 26/05/2026
Resumo da alteração: A Lei 15.415/2026 inclui o art. 73-A na Lei 8.213/91, estabelecendo prazo máximo de 30 dias para o INSS conceder o salário-maternidade pago diretamente pela Previdência Social. Caso o prazo não seja cumprido sem decisão definitiva, o benefício é concedido provisória e automaticamente, iniciando o pagamento imediatamente, antes de concluída a análise documental. Os valores pagos na concessão provisória não estão sujeitos a repetição, exceto em caso de má-fé comprovada. A norma protege especificamente empregadas domésticas, trabalhadoras rurais, contribuintes individuais (autônomas) e seguradas facultativas — todas as beneficiárias que recebem o benefício diretamente do INSS. Empregadas com carteira assinada no setor privado não são alcançadas pois recebem pelo empregador.
Impacto na advocacia: Requerimentos com mais de 30 dias sem decisão definitiva constituem situação de mora administrativa passível de concessão automática, eliminando a necessidade de mandado de segurança apenas pelo prazo. O escritório deve monitorar os prazos de todos os requerimentos de salário-maternidade em andamento. A irrepetibilidade dos valores pagos provisoriamente protege a cliente que agiu de boa-fé mesmo em caso de indeferimento posterior.
Estratégia: Verificar imediatamente todos os requerimentos de salário-maternidade pendentes de decisão. Para aqueles com mais de 30 dias sem resposta definitiva, notificar o INSS sobre a obrigação legal de concessão automática. Em caso de não cumprimento, propor mandado de segurança ou ação ordinária cumulada com tutela provisória para forçar o início do pagamento. Não há risco patrimonial para a cliente: valores pagos antes de eventual indeferimento são irrepetíveis.
Link oficial: https://www2.camara.leg.br/legin/fed/lei/2026/lei-15415-25-maio-2026-799179-norma-pl.html
