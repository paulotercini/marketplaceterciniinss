...
sumula = (doc("TRF3S42", "5000003-11.2022.4.03.6100", "ORGÃO ESPECIAL").replace(">Acórdão<", ">Súmula<")
           .replace("5000003-11.2022.4.03.6100<br/> 000", "42<br/>..PROCESSO_ANTIGO:<br/>42"))
(su,) = parser.extrair(sumula, "trf3")
assert (su["acervo"], su["numero_cnj"], su["classe_sigla"]) == ("sumulas", "42", "SUM"), su
...
assert banco.gravar(con, [su]) == 1 and banco.buscar(con, "", acervo="sumulas")["total"] == 1
assert banco.gravar(con, docs) == 1 and banco.gravar(con, docs) == 0, "reingestão tem de ser idempotente"
r = banco.buscar(con, "aposentadoria especial ruido", acervo="trf3")     # sem acento
...
assert v["total"] == 2 and v["por_acervo"] == {"trf3": 1, "sumulas": 1}, v
